...
<div id="pestReporte" class="tab-pane fade">
	<form name="formReporte" id="formReporte" method="POST" target="_blank"  action="../../reporte/<?=$vsModulo;?>/rep_<?=$vsVista;?>" accept-charset="utf-8" autocomplete="off">
		<div class="panel ">
					...
					<div class="form-group" >
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
							...
							<select name='cmbOrden' id='cmbOrden' class="form-control">
								<option value="id_modulo" selected="selected"> Identificador </option>
								<option value="nombre_modulo"> Nombre </option>
								<option value="estatus_modulo"> Estatus </option>
							</select>
						</div>
